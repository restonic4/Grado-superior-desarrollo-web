...
public class Gestion
{
	...
	public Gestion()
	{
		...
		System.out.println("\nApartado b) Clientas que han comprado m�s de 200:\n"+
		                   Arrays.toString(tienda.clientasPremium(200)));
		System.out.println("Apartado b) Clientas que han comprado m�s de 300:\n"+
	...
	{
		Prenda p1 = new Prenda(29.99f, "Camisetas", "M", "Camiseta b�sica");
		...
		Prenda p10 = new Prenda(25.00f, "Calzado", "L", "Botas de monta�a");
		tienda.anadePrenda(p10);
		Prenda p11 = new Prenda(30.00f, "Camisetas", "XL", "Camiseta deportiva");
		tienda.anadePrenda(p11);
		Prenda p12 = new Prenda(35.50f, "Pantalones", "S", "Pantalones de ch�ndal");
